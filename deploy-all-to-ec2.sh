...
JWT_EXPIRATION=7d
SUPABASE_URL=https://vobpumyuutgybakbyavd.supabase.co
SUPABASE_SERVICE_ROLE_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZvYnB1bXl1dXRneWJha2J5YXZkIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4MTUzMjY0OSwiZXhwIjoyMDk3MTA4NjQ5fQ.rgT51WZnHQCY_-9IRyGpBKL0pzjn_KM9WcQ0f4brNko
AWS_REGION=eu-west-1
SENDER_EMAIL=no-reply@raksha-ireland.com
EOF
fi
